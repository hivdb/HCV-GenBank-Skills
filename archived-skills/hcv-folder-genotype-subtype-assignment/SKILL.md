...
```bash
uv run python archived-skills/hcv-folder-genotype-subtype-assignment/scripts/assign_folder_genotype_subtype.py \
...
The default output directory is `archived-skills/outputs/folder_assignments`; pass `--output-dir` to override it.
