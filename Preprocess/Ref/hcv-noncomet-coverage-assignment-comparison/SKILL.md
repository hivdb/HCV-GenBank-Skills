...
```bash
.venv/bin/python Preprocess/Ref/hcv-noncomet-coverage-assignment-comparison/scripts/compare_coverage_and_assignments.py
```

Default input pairs are:

- `HCVData/HCV-all-seq-subtype/NS3_AllSeq_NonComet_Coverage.csv` and `outputs/folder_assignments/NS3_assignments.csv`
- `HCVData/HCV-all-seq-subtype/NS5A_AllSeq_NonComet_Coverage.csv` and `outputs/folder_assignments/NS5A_assignments.csv`
- `HCVData/HCV-all-seq-subtype/NS5B_AllSeq_NonComet_Coverage.csv` and `outputs/folder_assignments/NS5B_assignments.csv`

Outputs default to `outputs/noncomet-coverage-assignment-comparison/`:
