...
```bash
uv run python hcv-ns3-build-workflow/scripts/find_refid_fastas/find_refid_fastas.py \
...
```bash
./.venv/bin/python hcv-ns3-build-workflow/scripts/build_ns3_gt_allstudies/build_ns3_gt_allstudies.py \
  --excel-file /path/to/HCV_BlastHits_2026_04_29.xlsx \
  --sheet NS3_May11 \
...
```bash
./.venv/bin/python hcv-ns3-build-workflow/scripts/build_ns3_subtype_allstudies_wseqs/build_ns3_subtype_allstudies_wseqs.py \
...
```bash
./.venv/bin/python hcv-ns3-build-workflow/scripts/build_ns3_gt_ras_profiles/build_ns3_gt_ras_profiles.py \
...
```bash
./.venv/bin/python hcv-ns5a-build-workflow/scripts/build_ns5a_gt_ras_profiles/build_ns5a_gt_ras_profiles.py \
...
```bash
./.venv/bin/python hcv-ns5b-build-workflow/scripts/build_ns5b_gt_ras_profiles/build_ns5b_gt_ras_profiles.py \
...
```bash
./.venv/bin/python hcv-gene-genotype-subtype-ref-alignment/scripts/build_hcv_gene_subtype_refs/build_hcv_gene_subtype_refs.py \
...
1. Run `hcv-ns3-build-workflow/scripts/find_refid_fastas/find_refid_fastas.py` with:
   - `--sheet NS3_May11`
   - `--numpatients-column NumPts`
   - `--positive-column NS3Count`
2. Stage the matched FASTA files into a local temp directory.
3. Run `hcv-ns3-build-workflow/scripts/build_ns3_gt_allstudies/build_ns3_gt_allstudies.py`.
4. Convert `ns3_gt_distance_master.csv` to `NS3_Alignments_combined.xlsx`.
5. Run `hcv-ns3-build-workflow/scripts/build_ns3_subtype_allstudies_wseqs/build_ns3_subtype_allstudies_wseqs.py`.
6. Run `hcv-ns3-build-workflow/scripts/build_ns3_subtype_with_gt_aa/build_ns3_subtype_with_gt_aa.py`.
7. Run `hcv-ns3-build-workflow/scripts/build_ns3_completeprofiles_tabspergt/build_ns3_completeprofiles_tabspergt.py`.
8. Run `hcv-ns3-build-workflow/scripts/build_ns3_gt_ras_profiles/build_ns3_gt_ras_profiles.py`.
9. Run `hcv-ns3-build-workflow/scripts/build_ns3_subtype_ras_profiles/build_ns3_subtype_ras_profiles.py`.
...
1. Run `hcv-ns5a-build-workflow/scripts/find_refid_fastas/find_refid_fastas.py` with:
   - `--sheet NS5A_PtGT0_Check`
   - `--numpatients-column NumPts`
   - `--positive-column NS5ACount`
2. Stage the matched FASTA files into a local temp directory.
3. Run `hcv-ns5a-build-workflow/scripts/build_ns5a_gt_allstudies/build_ns5a_gt_allstudies.py`.
4. Convert `ns5a_gt_distance_master.csv` to `NS5A_Alignments_combined.xlsx`.
5. Run `hcv-ns5a-build-workflow/scripts/build_ns5a_subtype_allstudies_wseqs/build_ns5a_subtype_allstudies_wseqs.py`.
6. Run `hcv-ns5a-build-workflow/scripts/build_ns5a_subtype_with_gt_aa/build_ns5a_subtype_with_gt_aa.py`.
7. Run `hcv-ns5a-build-workflow/scripts/build_ns5a_completeprofiles_tabspergt/build_ns5a_completeprofiles_tabspergt.py`.
8. Run `hcv-ns5a-build-workflow/scripts/build_ns5a_gt_ras_profiles/build_ns5a_gt_ras_profiles.py`.
9. Run `hcv-ns5a-build-workflow/scripts/build_ns5a_subtype_ras_profiles/build_ns5a_subtype_ras_profiles.py`.
...
1. Run `hcv-ns5b-build-workflow/scripts/find_refid_fastas/find_refid_fastas.py` with:
   - `--sheet NS5B_PtGT0_Check`
   - `--numpatients-column NumPts`
   - `--positive-column NS5BCount`
2. Stage the matched FASTA files into a local temp directory.
3. Run `hcv-ns5b-build-workflow/scripts/build_ns5b_gt_allstudies/build_ns5b_gt_allstudies.py`.
4. Convert `ns5b_gt_distance_master.csv` to `NS5B_Alignments_combined.xlsx`.
5. Run `hcv-ns5b-build-workflow/scripts/build_ns5b_subtype_allstudies_wseqs/build_ns5b_subtype_allstudies_wseqs.py`.
6. Run `hcv-ns5b-build-workflow/scripts/build_ns5b_subtype_with_gt_aa/build_ns5b_subtype_with_gt_aa.py`.
7. Run `hcv-ns5b-build-workflow/scripts/build_ns5b_completeprofiles_tabspergt/build_ns5b_completeprofiles_tabspergt.py`.
8. Run `hcv-ns5b-build-workflow/scripts/build_ns5b_gt_ras_profiles/build_ns5b_gt_ras_profiles.py`.
9. Run `hcv-ns5b-build-workflow/scripts/build_ns5b_subtype_ras_profiles/build_ns5b_subtype_ras_profiles.py`.
...
- `hcv-ns3-build-workflow/scripts/find_refid_fastas/find_refid_fastas.py`
- `hcv-ns5a-build-workflow/scripts/find_refid_fastas/find_refid_fastas.py`
- `hcv-ns5b-build-workflow/scripts/find_refid_fastas/find_refid_fastas.py`
...
- `hcv-ns3-build-workflow/scripts/build_ns3_gt_allstudies/build_ns3_gt_allstudies.py`
...
- `hcv-ns3-build-workflow/scripts/build_ns3_subtype_allstudies_wseqs/build_ns3_subtype_allstudies_wseqs.py`
...
1. The selected NS build workflow runs its bundled `scripts/find_refid_fastas/find_refid_fastas.py` first to find study FASTA files from filtered spreadsheet rows.
2. `hcv-ns3-build-workflow/scripts/build_ns3_gt_allstudies/build_ns3_gt_allstudies.py` assigns `NS3` genotype to each accession.
3. `hcv-ns3-build-workflow/scripts/build_ns3_subtype_allstudies_wseqs/build_ns3_subtype_allstudies_wseqs.py` assigns `NS3` subtype to each accession using genotype-matched subtype references.

## New NS5A Workflow

I added `NS5A` counterparts to the existing `NS3` scripts:

1. `hcv-ns5a-build-workflow/scripts/build_ns5a_gt_allstudies/build_ns5a_gt_allstudies.py`
...
2. `hcv-ns5a-build-workflow/scripts/build_ns5a_subtype_allstudies_wseqs/build_ns5a_subtype_allstudies_wseqs.py`
...
1. `hcv-ns5b-build-workflow/scripts/build_ns5b_gt_allstudies/build_ns5b_gt_allstudies.py`
...
2. `hcv-ns5b-build-workflow/scripts/build_ns5b_subtype_allstudies_wseqs/build_ns5b_subtype_allstudies_wseqs.py`
