...
`scripts/build_hcv_gene_subtype_refs.py` locates per-gene sequences by
...
To rebuild `Reference_seqs/HCV_Subtype_Refs_NS3_AA.fasta`,
`HCV_Subtype_Refs_NS5A_NTD_AA.fasta`, and
`HCV_Subtype_Refs_NS5B_AA.fasta`, use
`scripts/rebuild_subtype_reference_aas_from_genbank.py` from the repository
