...
`scripts/build_hcv_gene_subtype_refs/build_hcv_gene_subtype_refs.py` locates per-gene sequences by
...
`scripts/rebuild_subtype_reference_aas_from_genbank/rebuild_subtype_reference_aas_from_genbank.py` from the repository
