#!/usr/bin/env python3
"""Create the NS5A subtype workbook directly from Comet assignments."""
...
def main() -> int:
    ...
    output = Workbook()
    sheet = output.active
    sheet.title = "NS5A_Subtype_Comet"
    sheet.append([
    ...
    for refid, refname, accession, genotype, subtype in rows:
        sheet.append([refid, refname, accession, genotype, subtype, "Comet", "Comet NS5A"])
