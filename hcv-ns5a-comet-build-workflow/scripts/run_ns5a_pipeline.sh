...
announce_step 9 "Build subtype study workbook from Comet" \
  "genotype workbook: $OUTPUT_DIR/NS5A_GT_AllStudies.xlsx; Comet subtype assignments: $COMET_SUBTYPING_CSV; non-COMET 1d and genotype 8 subtype assignments: $NONCOMET_SUBTYPE_WORKBOOK" \
