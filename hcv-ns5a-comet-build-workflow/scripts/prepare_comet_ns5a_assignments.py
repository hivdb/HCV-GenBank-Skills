#!/usr/bin/env python3
"""Prepare authoritative NS5A Comet assignments and remove unassigned FASTA records."""
...
def main() -> int:
    ...
    for fasta_path in sorted(fasta_dir.glob("*.fasta")):
        ...
        for record in read_fasta(fasta_path):
            ...
            assigned += 1
            kept.append(record)
            genotype_rows.append({"accession": accession, "genotype": genotype, "subtype": "", "column_name": "Comet NS5A"})
