...
11. `scripts/validate_ns3_profile_alignment/validate_ns3_profile_alignment.py`
12. `scripts/build_ns3_completeprofiles_tabspergt/build_ns3_completeprofiles_tabspergt.py`
13. `scripts/export_ns3_consensus_fasta/export_ns3_consensus_fasta.py`
14. `scripts/build_ns3_gt_ras_profiles/build_ns3_gt_ras_profiles.py`
15. `scripts/build_ns3_subtype_ras_profiles/build_ns3_subtype_ras_profiles.py`
16. `scripts/build_ns3_combined_ras_profiles/build_ns3_combined_ras_profiles.py`
17. `scripts/build_ns3_subtype_ras_consensus_difference_summary/build_ns3_subtype_ras_consensus_difference_summary.py`
18. `scripts/build_ns3_subtype_profile_coverage_report/build_ns3_subtype_profile_coverage_report.py` (GT5 subtype 5a coverage audit)
