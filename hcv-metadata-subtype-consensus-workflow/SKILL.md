...
```bash
python hcv-metadata-subtype-consensus-workflow/run_metadata_subtype_consensus_workflow/run_metadata_subtype_consensus_workflow.py --fasta-dir /path/to/fasta_dir
```
...
```bash
python hcv-metadata-subtype-consensus-workflow/run_metadata_subtype_consensus_workflow/run_metadata_subtype_consensus_workflow.py --only-consensus-alignments
```
