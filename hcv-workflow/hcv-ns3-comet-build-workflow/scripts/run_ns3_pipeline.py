...
class Pipeline:
    ...
    def steps(self) -> list[Step]:
        ...
        return [
            ...
            Step("compare-reference-consensus", "compare COMET consensus sequences to references", lambda: (self.run("export_gt_reference_consensus_differences.py", "--gene", "NS3", "--reference-fasta", REPO_ROOT / "HCVData/HCV_GT_Refs_NS3_NS5A_NTD_NS5B_AA.fasta", "--consensus-dir", self.output_dir, "--subtype-reference-dir", REPO_ROOT / "HCVData/Reference_seqs"), self.run("build_ns3_subtype_consensus_reference_distance.py", "--subtype-profile-workbook", subtype_profile, "--subtype-json", self.subtype_json, "--output-xlsx", self.output_dir / "NS3_Subtype_Consensus_Reference_AA_Distance_RAS.xlsx"))),
