...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--aligned-fasta", default="outputs/NS5A_GT_Consensus_aligned.fasta")
    parser.add_argument("--output-xlsx", default="outputs/NS5A_GT_AA_Distance_Pos24_93.xlsx")
    parser.add_argument(
        "--details-xlsx",
