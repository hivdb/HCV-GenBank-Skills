...
MINIMUM_CALLABLE_OTHER_RAS_POSITIONS = 5
...
def has_profile_required_positions(start: int, aa_sequence: str) -> bool:
    """Return whether position 282 and at least five other RAS positions are callable."""
    ...
    return (
        ...
        and len(callable_positions & set(OTHER_RAS_POSITIONS))
        >= MINIMUM_CALLABLE_OTHER_RAS_POSITIONS
    )
...
def main() -> int:
    ...
    print(
        ...
        "amino-acid at position 282 and at least five other RAS positions.",
        flush=True,
    )
    ...
    summary = {
        ...
        **counts,
        ...
        "profile_input_rule": "Every retained accession has a callable amino-acid at NS5B position 282 and at least five other RAS positions.",
