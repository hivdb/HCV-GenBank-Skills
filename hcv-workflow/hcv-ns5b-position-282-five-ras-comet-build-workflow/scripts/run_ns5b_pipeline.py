...
SKILL_NAME = "hcv-ns5b-position-282-five-ras-comet-build-workflow"
...
def load_config(config_path: Path) -> dict[str, str]:
    ...
    if config_path.is_file():
        ...
        for section_name in ("common", "ns5b_comet", "ns5b_position_282_five_ras"):
...
class Pipeline:
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        self.output_dir = path_value(
            value(
                "output_dir", "OUTPUT_DIR", "outputs/comet-NS5B-position-282-five-ras"
            )
        )
            ...
            Step(
                ...
                lambda: (
                    ...
                    self.run(
                        ...
                        "Missing or non-callable amino acid at required NS5B position 282 or fewer than five other callable RAS positions",
                        "--output-xlsx",
                        self.step_dir("build-combined-ras-reports")
