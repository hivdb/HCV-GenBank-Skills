...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--aligned-fasta", default="outputs/NS5B_GT_Consensus_aligned.fasta"
    )
    parser.add_argument(
        "--output-xlsx", default="outputs/NS5B_GT_AA_Distance_Pos150_321.xlsx"
    )
    parser.add_argument(
        "--details-xlsx",
        default="outputs/comet-NS5B-position-282-four-ras-include-or-short/temp/ns5b_gt_aa_distance_matrix/NS5B_GT_AA_Distance_Pos150_321_details.xlsx",
