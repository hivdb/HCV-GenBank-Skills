...
def main() -> int:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("outputs/comet-NS5B-position-282-four-ras-include-or-short"),
        help="Directory for generated comparison workbooks (default: outputs/comet-NS5B-position-282-four-ras-include-or-short).",
    )
    parser.add_argument(
