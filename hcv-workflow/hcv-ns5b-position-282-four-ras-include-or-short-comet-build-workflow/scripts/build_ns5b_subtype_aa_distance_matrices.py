...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "For each NS5B genotype, multiple-align subtype amino-acid consensus "
            "sequences, slice aligned positions 150-321, and write one distance "
            "matrix sheet per genotype."
        )
    )
    parser.add_argument("--input-fasta", default="outputs/NS5B_Subtype_Consensus.fasta")
    parser.add_argument(
        "--subtype-profile-workbook",
        default="outputs/NS5B_Subtype_CompleteProfiles_TabsPerGT.xlsx",
    ...
    parser.add_argument("--temp-dir", default="outputs/comet-NS5B-position-282-four-ras/temp/ns5b_subtype_aa_distance_matrices")
