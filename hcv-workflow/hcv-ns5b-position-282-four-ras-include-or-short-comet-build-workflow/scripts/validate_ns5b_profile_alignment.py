#!/usr/bin/env python3
"""Validate NS5B AA extractions whose linear coordinates cannot represent the alignment.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Validate NS5B profile coordinate mapping against genotype AA references."
    )
    ...
    parser.add_argument("--min-divergence-coverage", type=int, default=250)
