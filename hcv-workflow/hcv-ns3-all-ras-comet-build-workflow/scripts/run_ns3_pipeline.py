...
SKILL_NAME = "hcv-ns3-all-ras-comet-build-workflow"
...
def load_config(config_path: Path) -> dict[str, str]:
    ...
    if config_path.is_file():
        ...
        for section_name in ("common", "ns3_comet", "ns3_all_ras"):
...
class Pipeline:
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        self.output_dir = path_value(
            value("output_dir", "OUTPUT_DIR", "outputs/comet-NS3-all-ras")
        )
            ...
            Step(
                ...
                lambda: (
                    self.run(
                        ...
                        REPO_ROOT
                        / "HCVData/Reference_seqs/HCV_Subtype_Refs_NS3_AA_Pairwise_Aligned.fasta",
