...
class Pipeline:
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        self.output_dir = path_value(value("output_dir", "OUTPUT_DIR", "outputs/comet-NS3-all-ras"))
    ...
    def steps(self) -> list[Step]:
        ...
        def report_profile_counts() -> None:
            ...
            print(f"Complete-profile genotype distribution: {format_genotype_distribution(distribution)}")
