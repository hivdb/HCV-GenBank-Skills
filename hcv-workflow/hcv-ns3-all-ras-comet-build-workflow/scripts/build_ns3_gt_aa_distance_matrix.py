...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Multiple-align NS3 genotype amino-acid consensus FASTA, slice aligned "
            "positions 36-175, and write pairwise genotype amino-acid distances."
        )
    )
    ...
    parser.add_argument(
        "--details-xlsx",
        default="outputs/comet-NS3-all-ras/temp/ns3_gt_aa_distance_matrix/NS3_GT_AA_Distance_Pos36_175_details.xlsx",
