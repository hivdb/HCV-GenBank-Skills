...
SKILL_NAME = "hcv-ns5b-all-ras-comet-build-workflow"
...
def load_config(config_path: Path) -> dict[str, str]:
    ...
    if config_path.is_file():
        ...
        for section_name in ("common", "ns5b_comet", "ns5b_all_ras_include_or_short"):
    ...
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        self.output_dir = path_value(
            value(
                "output_dir",
                "OUTPUT_DIR",
                "outputs/comet-NS5B-all-ras-include-or-short",
            )
        )
            ...
            Step(
                ...
                lambda: (
                    ...
                    self.run(
                        ...
                        "Missing or non-callable amino acid at one or more required RAS positions (150, 159, 206, 282, 316, 320, 321)",
                        "--output-xlsx",
                        self.step_dir("build-combined-ras-reports")
