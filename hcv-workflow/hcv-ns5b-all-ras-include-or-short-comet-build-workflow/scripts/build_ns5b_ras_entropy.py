...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Calculate NS5B RAS-position Shannon entropy by genotype and subtype."
    )
    parser.add_argument(
        "--gt-profile-workbook",
        default="outputs/NS5B_GT_CompleteProfiles_TabsPerGT.xlsx",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--subtype-output-xlsx", default="outputs/NS5B_Subtype_RAS_Entropy.xlsx"
    )
