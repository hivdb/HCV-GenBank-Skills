...
class Pipeline:
    ...
    def steps(self) -> list[Step]:
        ...
        return [
            ...
            Step("build-genotype-workbook", "build the COMET genotype workbook", lambda: self.run("build_ns5a_comet_gt_allstudies.py", "--fasta-dir", self.included_fasta_dir, "--comet-genotype-csv", comet_gt_csv, "--priority-assignments-csv", self.priority_assignments_csv, "--output-dir", self.step_dir("build-genotype-workbook"), stdout_path=summary("build-genotype-workbook"))),
