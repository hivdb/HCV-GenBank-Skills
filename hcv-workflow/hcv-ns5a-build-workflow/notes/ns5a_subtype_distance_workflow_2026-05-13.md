Create a combined NS5A subtype assignment workbook from the existing NS5A genotype workbook.

Inputs:
- `NS5A_Alignments_combined.xlsx`
- `HCV_Subtype_Refs_By_Genome_NA.json`
- the study FASTA directory used for the NS5A genotype workflow
