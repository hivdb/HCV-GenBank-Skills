...
class Pipeline:
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        self.output_dir = path_value(value("output_dir", "OUTPUT_DIR", "outputs/comet-NS5B"))
        ...
        self.local_assignments_csv = path_value(value("local_assignments_csv", "LOCAL_ASSIGNMENTS_CSV", "outputs/folder_assignments/NS5B_assignments.csv"))
    ...
    def steps(self) -> list[Step]:
        ...
        return [
            ...
            Step("select-noncomet-priority-assignments", "select local assignments that override or supplement COMET", lambda: self.run("select_noncomet_priority_assignments.py", "--local-assignments-csv", self.local_assignments_csv, "--fasta-dir", self.fasta_pool, "--comet-unassigned-csv", self.temp_root / "comet_ns5b_not_found_or_unassigned.csv", "--output-csv", self.priority_assignments_csv, stdout_path=summary("select-noncomet-priority-assignments"))),
