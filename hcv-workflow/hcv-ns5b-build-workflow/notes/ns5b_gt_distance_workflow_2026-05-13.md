...
Create one Excel file for each study FASTA file and place them in a directory called NS5B_Alignments.xlsx so progress can be inspected before later combining them.
