...
15. `build_ns5b_combined_ras_profiles/build_ns5b_combined_ras_profiles.py`

Prefer the wrapper when running the full workflow:

```bash
EXCEL_FILE=/path/to/HCV_BlastHits.xlsx FASTA_POOL=/path/to/FASTA hcv-workflow/hcv-ns5b-build-workflow/scripts/run_ns5b_pipeline.sh
```
