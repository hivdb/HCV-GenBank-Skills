...
EXCLUDED_AAS = {"X", "*"}
POSITION_COLUMN = "NS5BPosition"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Calculate NS5B RAS-position Shannon entropy by genotype and subtype.")
    parser.add_argument("--gt-profile-workbook", default="outputs/NS5B_GT_CompleteProfiles_TabsPerGT.xlsx")
    parser.add_argument("--subtype-profile-workbook", default="outputs/NS5B_Subtype_CompleteProfiles_TabsPerGT.xlsx")
    parser.add_argument("--gt-output-xlsx", default="outputs/NS5B_GT_RAS_Entropy.xlsx")
    parser.add_argument("--subtype-output-xlsx", default="outputs/NS5B_Subtype_RAS_Entropy.xlsx")
