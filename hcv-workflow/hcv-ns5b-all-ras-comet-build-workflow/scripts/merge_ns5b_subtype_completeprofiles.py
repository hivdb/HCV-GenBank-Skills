#!/usr/bin/env python3
"""Merge NS5B subtype complete-profile worksheets into one simplified table."""
...
COLUMNS = ["Subtype", "NS5BPosition", "NumSeqsIncludingPosition", "AminoAcid", "CountWithAA", "PctWithAA"]
...
def main() -> int:
    ...
    output = Workbook()
    sheet = output.active
    sheet.title = "NS5B_Subtype_CompleteProfiles"
