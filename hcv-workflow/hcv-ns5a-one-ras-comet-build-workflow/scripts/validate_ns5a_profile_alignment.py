#!/usr/bin/env python3
"""Validate NS5A AA extractions whose linear coordinates cannot represent the alignment.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Validate NS5A profile coordinate mapping against genotype AA references."
    )
