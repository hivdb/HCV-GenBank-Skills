...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "For each NS5A genotype, multiple-align subtype amino-acid consensus "
            "sequences, slice aligned positions 24-93, and write one distance "
    ...
    parser.add_argument(
        "--output-xlsx", default="outputs/NS5A_Subtype_AA_Distance_Pos24_93.xlsx"
    )
    parser.add_argument(
        "--temp-dir",
        default="outputs/comet-NS5A-one-ras/temp/ns5a_subtype_aa_distance_matrices",
    )
    parser.add_argument(
