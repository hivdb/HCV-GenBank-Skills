...
def has_callable_ras_position(start: int, aa_sequence: str) -> bool:
    """Return whether any NS3 RAS position has a callable standard amino-acid call."""
...
def main() -> int:
    ...
    summary = {
        ...
        **counts,
        ...
        "profile_input_rule": "Every retained accession has a callable amino-acid at one or more NS3 RAS positions.",
