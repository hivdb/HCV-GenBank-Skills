...
11. `build_ns3_completeprofiles_tabspergt/build_ns3_completeprofiles_tabspergt.py`
12. `export_ns3_consensus_fasta/export_ns3_consensus_fasta.py`
13. `build_ns3_gt_ras_profiles/build_ns3_gt_ras_profiles.py`
14. `build_ns3_subtype_ras_profiles/build_ns3_subtype_ras_profiles.py`
15. `build_ns3_combined_ras_profiles/build_ns3_combined_ras_profiles.py`

Prefer the wrapper when running the full workflow:

```bash
EXCEL_FILE=/path/to/HCV_BlastHits.xlsx FASTA_POOL=/path/to/FASTA hcv-workflow/hcv-ns3-build-workflow/scripts/run_ns3_pipeline.sh
```
