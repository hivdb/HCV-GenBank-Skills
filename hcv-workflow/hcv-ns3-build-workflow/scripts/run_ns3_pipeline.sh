...
usage() {
  cat <<'EOF'
Usage:
  EXCEL_FILE=/path/to/HCV_BlastHits.xlsx SHEET_NAME=NS3_PtGT0_Check FASTA_POOL=/path/to/FASTA [GENBANK_DIR=/path/to/genbank_seq_files] hcv-workflow/hcv-ns3-build-workflow/scripts/run_ns3_pipeline.sh
...
announce_step 10 "Build complete profile workbooks" \
  ...
  "profile workbooks: $OUTPUT_DIR/NS3_GT_CompleteProfiles_TabsPerGT.xlsx; $OUTPUT_DIR/NS3_Subtype_CompleteProfiles_TabsPerGT.xlsx; profile accessions: $OUTPUT_DIR/NS3_Profile_Accessions.csv"
...
"$PYTHON_BIN" "$SCRIPT_DIR/export_ns3_consensus_fasta.py" \
  ...
  --output-dir "$OUTPUT_DIR" \
  > /dev/null
"$PYTHON_BIN" "$SCRIPT_DIR/build_ns3_subtype_consensus_reference_distance.py" --subtype-profile-workbook "$OUTPUT_DIR/NS3_Subtype_CompleteProfiles_TabsPerGT.xlsx" --subtype-json "$SUBTYPE_JSON" --output-xlsx "$OUTPUT_DIR/NS3_Subtype_Consensus_Reference_AA_Distance_RAS.xlsx"
...
"$PYTHON_BIN" "$SCRIPT_DIR/build_ns3_aa_distance_matrices.py" --input-workbook "$AA_TMP_WORKBOOK" --profile-accessions-csv "$OUTPUT_DIR/NS3_Profile_Accessions.csv" --gt-output-xlsx "$OUTPUT_DIR/NS3_GT_AA_Distance_RAS.xlsx" --subtype-output-xlsx "$OUTPUT_DIR/NS3_Subtype_AA_Distance_RAS.xlsx" --min-subtype-sequences 10
"$PYTHON_BIN" "$SCRIPT_DIR/build_ns3_na_distance_matrices.py" --input-workbook "$AA_TMP_WORKBOOK" --profile-accessions-csv "$OUTPUT_DIR/NS3_Profile_Accessions.csv" --gt-output-xlsx "$OUTPUT_DIR/NS3_GT_NA_Distance_RAS.xlsx" --subtype-output-xlsx "$OUTPUT_DIR/NS3_Subtype_NA_Distance_RAS.xlsx" --min-subtype-sequences 10
"$PYTHON_BIN" "$SCRIPT_DIR/build_ns3_aa_distance_matrices.py" --input-workbook "$AA_TMP_WORKBOOK" --profile-accessions-csv "$OUTPUT_DIR/NS3_Profile_Accessions.csv" --gt-output-xlsx "$OUTPUT_DIR/NS3_GT_AA_Distance_Pos36_175.xlsx" --subtype-output-xlsx "$OUTPUT_DIR/NS3_Subtype_AA_Distance_Pos36_175.xlsx" --min-subtype-sequences 10 --start 36 --end 175
"$PYTHON_BIN" "$SCRIPT_DIR/build_ns3_na_distance_matrices.py" --input-workbook "$AA_TMP_WORKBOOK" --profile-accessions-csv "$OUTPUT_DIR/NS3_Profile_Accessions.csv" --gt-output-xlsx "$OUTPUT_DIR/NS3_GT_NA_Distance_Pos36_175.xlsx" --subtype-output-xlsx "$OUTPUT_DIR/NS3_Subtype_NA_Distance_Pos36_175.xlsx" --min-subtype-sequences 10 --start 36 --end 175
