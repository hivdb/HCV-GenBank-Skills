...
6. `scripts/build_ns3_gt_allstudies/build_ns3_gt_allstudies.py`
7. `scripts/build_ns3_sourcefeatures_csv/build_ns3_sourcefeatures_csv.py` is currently commented out in the wrapper
8. `scripts/build_ns3_sourcefeatures_grouped_csv/build_ns3_sourcefeatures_grouped_csv.py` is currently commented out in the wrapper
9. `scripts/build_ns3_subtype_allstudies_wseqs/build_ns3_subtype_allstudies_wseqs.py`
10. `scripts/build_ns3_subtype_with_gt_aa/build_ns3_subtype_with_gt_aa.py`
11. `scripts/build_ns3_completeprofiles_tabspergt/build_ns3_completeprofiles_tabspergt.py`
12. `scripts/export_ns3_consensus_fasta/export_ns3_consensus_fasta.py`
13. `scripts/build_ns3_gt_ras_profiles/build_ns3_gt_ras_profiles.py`
14. `scripts/build_ns3_subtype_ras_profiles/build_ns3_subtype_ras_profiles.py`
15. `scripts/build_ns3_combined_ras_profiles/build_ns3_combined_ras_profiles.py`
...
Temporary files and step summaries are written under `outputs/temp/hcv-ns3-build-workflow/`.
...
After discovery, the wrapper copies all matched RefID FASTA files into `outputs/temp/hcv-ns3-build-workflow/run_ns3_pipeline/included_refid_fastas/`. Downstream steps that accept `--fasta-dir` must use this copied folder, not the original TOML `fasta_pool`.
...
- discovery `filtered_rows.xlsx` under `outputs/temp/hcv-ns3-build-workflow/.../find_refid_fastas/...`
- copied included RefID FASTA files under `outputs/temp/hcv-ns3-build-workflow/run_ns3_pipeline/included_refid_fastas/`
...
- Keep temporary outputs under `outputs/temp/hcv-ns3-build-workflow/` so they do not mix with other skills.
