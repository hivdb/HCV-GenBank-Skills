...
def main():
 ...
 wb=load_workbook(a.subtype_profile_workbook,read_only=True,data_only=True); out=Workbook(); wsout=out.active; wsout.title='subtype_reference_distance'; wsout.append(['Genotype','Subtype','ReferenceAccession','ComparedAA','Differences','Distance','Status'])
